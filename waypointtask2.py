...
coordinate = [ [5.57,-5.63], [5.55, 5.54], [-5.6,5.54],[0,0,30]]
i = 0
...
class DroneFly():
    ...
    def isThere(self):
        global i
        if (self.drone_x < abs(0.2)  and self.drone_y< abs(0.2) and i>2):
            self.disarm()
        elif( self.drone_x > self.wp_x-0.2 and  self.drone_x< self.wp_x+0.2):
    ...
    def pid_yaw(self):
        ...
        self.P_value_yaw = 43 * self.error_yaw      #Replace 43 with kp_yaw and so on to use PID tune
    ...
    def pid_roll(self):
        ...
        self.P_value_roll = 250 * self.error_roll       #Replace 43 with kp_roll and so on to use PID tune package
        self.D_value_roll = 350 * ( self.error_roll - self.DerivatorR)
        ...
        self.I_value_roll = self.IntegratorR * 800
    ...
    def pid_pitch(self):
        ...
        self.P_value_pitch = 250 * self.error_pitch
        self.D_value_pitch = 350 * ( self.error_pitch - self.DerivatorP)
        ...
        self.I_value_pitch = self.IntegratorP * 800
